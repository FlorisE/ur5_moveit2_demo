...
def generate_launch_description():
    ...
    controllers_yaml = load_yaml('ur5_run_move_group', 'config/controllers.yaml')
    ...
    # RViz
    rviz_config_file = get_package_share_directory('ur5_run_move_group') + "/launch/ur5_run_move_group.rviz"
    ...
    fake_joint_driver_node = Node(package='fake_joint_driver',
                                  ...
                                  parameters=[{'controller_name': 'ur5_e_controller'},
                                              os.path.join(get_package_share_directory("ur5_run_move_group"), "config", "ur5_controllers.yaml"),
                                              os.path.join(get_package_share_directory("ur5_run_move_group"), "config", "start_positions.yaml"),
                                              robot_description]
                                  )
